...
@InputType()
export class TrialScalarWhereWithAggregatesInput {

    @Field(() => [TrialScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<TrialScalarWhereWithAggregatesInput>;

    @Field(() => [TrialScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<TrialScalarWhereWithAggregatesInput>;

    @Field(() => [TrialScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<TrialScalarWhereWithAggregatesInput>;
